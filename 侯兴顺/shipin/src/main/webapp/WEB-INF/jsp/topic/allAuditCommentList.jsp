   ...
   <c:forEach items="${pageView.records}" var="entry">
	  <TR >
	    ...
	    <TD width="15%">
	    	...
	    	<a href="${config:url(pageContext.request)}control/topic/manage${config:suffix()}?method=view&topicId=${entry.topicId}&commentId=${entry.id}&origin=3&topicPage=${param.page}">查看</a>
