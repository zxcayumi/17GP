...
<LINK href="backstage/css/list.css?2dddddddd" type="text/css" rel="stylesheet">
...
<script type="text/javascript" language="javascript"> 
	...
	function tagSubmit(){
		...
		$("#tagForm").ajaxSubmit({
	        ...
	        url:'control/questionTag/manage.htm?method=add'+context,// 表单提交的路径
...
<TABLE class=t-table cellSpacing=1 cellPadding=2 width="100%" border=0>
  <TBODY>
	<c:if test="${param.parentId != null && param.parentId >0 }">
		<TR>
	...
	<TR>
	    ...
	    <TD class=t-content width="88%" colSpan=3>
	    	<input type="text" class="form-text" id="name" maxlength="190" size="50">
	...
	<TR>
	    ...
	    <TD class="t-content" width="88%" colSpan="3">
	    	<input type="text" class="form-text" id="sort" maxlength="8" size="8" value="1">
