...
<DIV class="d-box">
<div class="d-button">
	<input class="functionButton" type="button" onClick="javascript:window.location.href='${config:url(pageContext.request)}control/help/list${config:suffix()}'" value="返回">
</div>
...
initKindEditor(${param.helpTypeId});
