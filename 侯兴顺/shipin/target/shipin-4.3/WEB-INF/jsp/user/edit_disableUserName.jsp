...
<DIV class="d-box">
<div class="d-button">
	<input class="functionButton" type="button" onClick="javascript:window.location.href='${config:url(pageContext.request)}control/disableUserName/list${config:suffix()}?page=${param.page}'" value="返回">
</div>
