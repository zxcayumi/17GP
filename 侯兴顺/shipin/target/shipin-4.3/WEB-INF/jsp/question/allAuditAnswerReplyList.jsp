  ...
  <TBODY class="t-list-tbody" align="center">
   <c:forEach items="${pageView.records}" var="entry">
	  <TR >
	    ...
	    <TD width="15%">
	    	<A onclick="javascript:if(window.confirm('确定发布吗? ')){auditAnswerReply('${entry.id}');return false;}else{return false};" hidefocus="true" href="#" ondragstart= "return false">立即审核</A>
	    	<a href="${config:url(pageContext.request)}control/question/manage${config:suffix()}?method=view&questionId=${entry.questionId}&answerId=${entry.answerId}&origin=4&questionPage=${param.page}">查看</a>
