  ...
  <TBODY class="t-list-tbody" align="center">
   <c:forEach items="${pageView.records}" var="entry">
	  <TR >
	    ...
	    <TD width="15%">
	    	<A onclick="javascript:if(window.confirm('确定发布吗? ')){auditReply('${entry.id}');return false;}else{return false};" hidefocus="true" href="#" ondragstart= "return false">立即审核</A>
	    	<a href="${config:url(pageContext.request)}control/topic/manage${config:suffix()}?method=view&topicId=${entry.topicId}&commentId=${entry.commentId}&origin=4&topicPage=${param.page}">查看</a>
