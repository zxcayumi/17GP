   ...
   <c:forEach items="${pageView.records}" var="entry">
	  <TR >
	    ...
	    <TD width="15%">
	    	...
	    	<a href="${config:url(pageContext.request)}control/question/manage${config:suffix()}?method=view&questionId=${entry.questionId}&answerId=${entry.id}&userName=${param.userName}&id=${param.id}&queryState=${param.queryState}&jumpStatus=${param.jumpStatus}&userPage=${param.userPage}&answerPage=${param.page}&origin=20">查看</a>
