...
function sureSubmit(){
	...
	post_request(function(value){
		...
		"${config:url(pageContext.request)}control/answer/manage${config:suffix()}?method=addAnswerReply&timestamp=" + new Date().getTime(), true,parameter);
...
<form:form>
<input type="hidden" id="answerId" value="${param.answerId}">
<DIV class="d-box">
<TABLE class="t-table" cellSpacing="1" cellPadding="2" width="100%" border="0">
  <TBODY>
    <TR>
    <TD class="t-content" >
    	<textarea class="form-textarea" id="content" name="content" style="width:99%;height:300px;"></textarea>
    </TD>
   </TR>
	<TR>
    <TD class="t-button">
