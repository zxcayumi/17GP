...
function sureSubmit(){
	...
	post_request(function(value){
		...
		"${config:url(pageContext.request)}control/question/manage${config:suffix()}?method=appendQuestion&timestamp=" + new Date().getTime(), true,parameter);
...
<TABLE class="t-table" cellSpacing="1" cellPadding="2" width="100%" border="0">
  <TBODY>
    ...
    <TD class="t-content" width="88%">
    	<textarea id="content" name="content" style="width:99%;height:400px;visibility:hidden;">${content}</textarea>
