...
<TABLE class="t-list-table" cellSpacing="1" cellPadding="0" width="100%" border="0">
  ...
  <TBODY class="t-list-tbody" align="center">
   <c:forEach items="${pageView.records}" var="entry">
	  <TR > 
	    <TD width="70%">
	    	<a href="${config:url(pageContext.request)}control/topic/manage${config:suffix()}?method=view&topicId=${entry.topicId}&origin=40&userName=${param.userName}&id=${param.id}&queryState=${param.queryState}&jumpStatus=${param.jumpStatus}&userPage=${param.userPage}&likePage=${param.page}">${entry.topicTitle}</a>
	    </TD>
	    <TD width="30%">
