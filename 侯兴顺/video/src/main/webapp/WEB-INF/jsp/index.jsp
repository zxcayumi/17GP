...
<div class="container">
    <div class="news-paper">
        <div class="header">
            <div class="header-left">
                <div class="logo">
                    <a href="index.html">
                        <h6>the</h6>
                        <h1>分享创作网站 <span>Reporter</span></h1>
                    </a>
                </div>
            </div>
            <div class="social-icons">
                ...
                <div class="fb-like" data-href="https://www.facebook.com/5imoban.net" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div>
                                    ...
                                    <div class="user_login">
                                        <form>
                                            ...
                                            <div class="checkbox">
                                                ...
                                                <label for="remember">记住电脑</label>
                                            </div>

                                            <div class="action_btns">
                                                <div class="one_half"><a href="#" class="btn back_btn"><i class="fa fa-angle-double-left"></i> 返回</a></div>
                                                <div class="one_half last"><a href="#" class="btn btn_red">登陆</a></div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="user_register">
                                        <form>
                                            ...
                                            <div class="checkbox">
                                                ...
                                                <label for="send_updates">偶尔给我发邮件更新</label>
                                            </div>
        ...
        <div class="menu-strip">
            <ul>
                <li><a href="index.html">世界新闻</a></li>
                <li><a href="sports.html">运动</a></li>
                <li><a href="tech.html">xxxx</a></li>
                <li><a href="business.html">商业</a></li>
                <li><a href="movies.html">电影</a></li>
                <li><a href="movies.html">动漫</a></li>
                <li><a href="books.html">书籍</a></li>
                <li><a href="movies.html">文化</a></li>
                <li><a href="classifieds.html">广告</a></li>
            ...
            <div class="col-md-3 side-bar">
                <div class="videos">
                    ...
                    <div class="video-grid">
                        ...
                        <div class="video-name">
                            <a href="single.html">Lorem ipsum dolor sit 网页特效 conse ctetur adipiscing elit</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="video-grid">
        ...
        <div class="footer text-center">
            ...
            <div class="copyright text-center">
                <p>Template by <a href="http://www.5imoban.net.com" target="_blank" title="静态网页模板">我爱模板网</a></p>|<p>Template by <a href="http://www.5imoban.net.com" target="_blank" title="静态网页模板">我爱模板网</a></p>
            </div>
        </div>
    </div>
</div>
